...
export function AddSubscriptionDialog() {
  ...
  const [frequency, setFrequency] = useState<"daily" | "weekly" | "15days" | "monthly" | "yearly">("monthly");
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <Select value={frequency} onValueChange={(v) => setFrequency(v as "daily" | "weekly" | "15days" | "monthly" | "yearly")} disabled={isSubmitting}>
                ...
                <SelectContent className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 shadow-xl">
                  ...
                  <SelectItem value="15days">Every 15 Days</SelectItem>
